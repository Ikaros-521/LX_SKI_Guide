        ...
        <div className="grid md:grid-cols-4 gap-8">
          ...
          <div className="col-span-1">
            <div className="flex items-center space-x-2 mb-4">
              ...
              <span className="text-xl font-bold">洛曦 滑雪攻略</span>
            </div>
            <p className="text-gray-400 text-sm leading-relaxed">
              专业的滑雪指导平台，为滑雪爱好者提供全方位的滑雪攻略、装备推荐和技巧教学。
            </p>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2 text-gray-400">
              <li><a href="#" className="hover:text-white transition-colors">视频教程</a></li>
              <li><a href="#" className="hover:text-white transition-colors">装备评测</a></li>
              <li><a href="#" className="hover:text-white transition-colors">雪场对比</a></li>
              <li><a href="#" className="hover:text-white transition-colors">滑雪社区</a></li>
            </ul>
          </div>
        ...
        <div className="border-t border-gray-800 mt-8 pt-8">
          <div className="flex flex-col md:flex-row justify-between items-center">
            ...
            <div className="flex space-x-6 mt-4 md:mt-0">
              ...
              <a href="#" className="text-gray-400 hover:text-white text-sm transition-colors">免责声明</a>
            </div>
          </div>
        </div>
      </div>
